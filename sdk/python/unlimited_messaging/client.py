...
class UnlimitedMessagingApi:
    ...
    environment : UnlimitedMessagingApiEnvironment
        The environment to use for requests from the client. from .environment import UnlimitedMessagingApiEnvironment



        Defaults to UnlimitedMessagingApiEnvironment.PRODUCTION
    ...
    def __init__(
        ...
        *,
        ...
        environment: UnlimitedMessagingApiEnvironment = UnlimitedMessagingApiEnvironment.PRODUCTION,
        token: typing.Union[str, typing.Callable[[], str]],
